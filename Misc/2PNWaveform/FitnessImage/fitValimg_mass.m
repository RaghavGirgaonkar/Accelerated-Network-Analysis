function []=fitValimg_mass(filename)
...
m1_lin = linspace(params.fitnessimage.m_range(1), params.fitnessimage.m_range(2), ngridpoints);
m2_lin = linspace(params.fitnessimage.m_range(1), params.fitnessimage.m_range(2), ngridpoints);
...
parfor i = 1:nindex
    ...
    for j = 1:nindex
         ...
         fitvals(i,j) = -1*mfqc([m1_lin(startidx_tau0+i-1), m2_lin(startidx_tau1p5+j-1)], inParams);
    end
