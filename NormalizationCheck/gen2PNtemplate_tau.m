function signal = gen2PNtemplate_tau(fpos, ta, phase, fmin, fmax,tau0, tau1p5,datalen,initial_phase,snr,N, A, avec, PSDtotal)
...
normfac = 1/sqrt(innerproduct_W(wf,wf,PSDtotal));
