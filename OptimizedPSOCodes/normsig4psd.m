function [normSigVec,normFac]=normsig4psd(fsigVecbyPSD, sampFreq, snr)
...
% normSigSqrd = innerprodpsd_fft(fsigVec,sampFreq,psdVec);
dataLen = sampFreq*nSamples;
innProd = (1/dataLen)*(fsigVecbyPSD)*fsigVecbyPSD';
normSigSqrd = real(innProd);
% Normalization factor
normFac = snr/sqrt(normSigSqrd);
% Normalize signal to specified SNR
normSigVec = normFac*fsigVecbyPSD;
